<div id="install-sheet" class="install-sheet" hidden>
  <div class="install-sheet-inner">
    <button type="button" id="install-close" class="install-close" aria-label="<?= e(t('common.close')) ?>"><?= icon('close', 'icon', 16) ?></button>

    <div id="install-android" hidden>
      <div class="install-icon"><?= icon('smartphone', 'icon icon-xl') ?></div>
    ...
    <div id="install-ios" hidden>
      ...
      <ol class="install-steps">
        <li><span class="install-step-num">1</span> <?= e(t('install.ios_step1')) ?> <span class="install-share-icon"><?= icon('upload', 'icon', 16) ?></span></li>
...
<div id="install-reminder" class="install-reminder" hidden>
  ...
  <button type="button" id="install-reminder-close" class="install-close" aria-label="<?= e(t('common.close')) ?>"><?= icon('close', 'icon', 16) ?></button>
</div>
