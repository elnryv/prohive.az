 ...
 * @var callable $t
 */
$aktivSehife = 'musteriler';
require __DIR__ . '/partials/shell_head.php';
?>
<div class="admin-topbar">
  <h1><?= htmlspecialchars($t('admin.musteriler')) ?></h1>
</div>
...
<div class="glass" style="padding:8px 16px;">
  <table>
    <thead><tr><th>Ad Soyad</th><th>Telefon</th><th>Status</th><th>Tarix</th></tr></thead>
...
(function () {
  ...
  async function detalGoster(id) {
    ...
    html += '<p style="color:var(--text-dim); font-size:13px;">Sözləşmə qəbulu: ' + BirlikdeAdmin.escapeHtml(u.sozlesme_tarix || '—') + '</p>';
