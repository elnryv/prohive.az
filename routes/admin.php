...
$router->get('/abune-qiymeti', [AdminAbunelikController::class, 'qiymet'], [AdminAuth::class]);
$router->post('/abune-qiymeti', [AdminAbunelikController::class, 'qiymetTeyinEt'], [AdminAuth::class, CsrfGuard::class]);
